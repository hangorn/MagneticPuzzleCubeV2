...
function LevelsModeView(sce, l, mats) {
	 ...
	 ******************************************************************************************************************/
	/**
	 * Constructor de la clase LevelModeView
	 * 
	 * @param Scene:sce
	...
	/**
	 * Método que se ejecutará la terminar un puzzle
	 */
	...
	/**
	 * Método para iniciar el nivel indicado
	 * 
	 * @param Integer:l
	 *            entero que indicará el nivel a iniciar.
	 * @param Boolean:restart
	 *            flag para saber si hay que reiniciar el nivel o no. Si se reinicia el nivel se utilizan las mismas
