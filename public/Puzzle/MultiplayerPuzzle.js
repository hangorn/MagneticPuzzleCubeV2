	...
	var getFaceCubes = function(face, center) {
		...
		if (numberOfCubes == 3) {
			...
			case 2:
				...
				for (var i = 1; i > -2; i--) {
					for (var j = -1; j < 2; j++) {
						cubes.push(getCube(new THREE.Vector3(-cubeSize + center.x, cubeSize * i + center.y, cubeSize
								* j + center.z)));
					}
				}
				break;
			...
			case 4:
				...
				for (var i = 1; i > -2; i--) {
					for (var j = -1; j < 2; j++) {
						cubes.push(getCube(new THREE.Vector3(cubeSize * j + center.x, -cubeSize + center.y, cubeSize
								* i + center.z)));
					}
				}
				break;
			...
			case 6:
				...
				for (var i = -1; i < 2; i++) {
					for (var j = -1; j < 2; j++) {
						cubes.push(getCube(new THREE.Vector3(cubeSize * j + center.x, cubeSize * i + center.y,
								-cubeSize + center.z)));
					}
				}
				break;
