...
function HelpView() {
	 ...
	 ******************************************************************************************************************/
	/**
	 * Constructor de la clase HelpView
	 */
	// Creamos los textos
	// Ayuda del menú
	helpText.push([]);
	...
	helpText[0]
			.push("<p>Con la cuarta opción se pueden consultar todas las puntuaciones obtenidas hasta la fecha por todos los usuarios que han querido guardarlas. Se muestran agrupadas por los distintos modos en los que se han conseguido y ordenadas de mejor a peor.</p>");
