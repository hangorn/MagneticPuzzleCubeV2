...
function ScoresView() {
	 ...
	 ******************************************************************************************************************/
	/**
	 * Constructor de la clase ScoresView
	 */
	...
	/**
	 * Método para crear una pestaña con el nombre de un modo
	 * 
	 * @param String:name
	 *            nombre del modo con el que se creará la pestaña.
	 */
	...
	/**
	 * Método para crear las pestañas para mostrar las puntuaciones de todos los modos.
	 */
	...
	/**
	 * Método para añadir una puntuacion al contenedor de puntuaciones
	 * 
	 * @param Score:score->
	...
	/**
	 * Método para borrar todos las puntuaciones que se estan mostrando
	 */
	...
	this.showSubmode = function(submode) {
		...
		if (lastSubmodeSelected != undefined && lastSubmodeSelected != submode
				&& lastSubmodeSelected < submodes[lastModeSelected].length) {
		...
		socket.getScores(lastModeSelected, lastSubmodeSelected, function(scores) {
			showScores(scores);
		});
	...
	this.showMode = function(mode) {
		// Comprobamos que sea un modo correcto o que no este ya seleccionado
		if (mode < 0 || mode >= modesCont.getElementsByTagName('div').length
				|| (lastModeSelected != undefined && mode == lastModeSelected)) {
			return
